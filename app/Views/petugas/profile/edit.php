...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Edit Profil Pengguna</h2>
    ...
    <form method="post" action="<?= site_url('profile/update') ?>">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= (session('errors.nama')) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= old('nama', esc($user['nama'])) ?>" required>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= (session('errors.username')) ? 'is-invalid' : '' ?>" id="username" name="username" value="<?= old('username', esc($user['username'])) ?>" required>
        ...
        <div class="d-flex justify-content-end">
            <a href="/petugas/pasien" class="btn btn-outline-secondary me-2">
...
<script>
    // Menggunakan vanilla JS untuk modal agar konsisten dan mengurangi ketergantungan jQuery jika memungkinkan
